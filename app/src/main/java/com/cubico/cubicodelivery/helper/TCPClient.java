...
public class TCPClient {
     ...
     * */
    public String serverIp = "172.16.32.3"; // your computer IP address
    ...
    public void run() {
        ...
        try {
            ...
            Log.e("TCP SI Client", "SI: Connecting..." + serverAddr.getHostName() );
            ...
            {
                Log.e("TCP SI Error run", "SI: Error", e);
                e.printStackTrace();
            }
            finally
            {
            ...
            Log.e("TCP SI Error mai", "SI: Error", e);
